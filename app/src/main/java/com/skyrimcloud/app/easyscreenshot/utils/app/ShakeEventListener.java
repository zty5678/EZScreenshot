...
/**
 * from https://github.com/square/seismic/
...
//    public static final int SENSITIVITY_HARD = 15;
    ...
    private static int DEFAULT_ACCELERATION_THRESHOLD = ShakeSensitivity.getDefault().value;

    public static void setDefaultSensitivity(ShakeSensitivity sensitivity){
        DEFAULT_ACCELERATION_THRESHOLD=ShakeSensitivity.getIntValue(sensitivity);
    }
    public enum ShakeSensitivity{
        ...
        hard(15);
        int value;
        ShakeSensitivity(int value){
            this.value=value;
        }
        public static int getIntValue(ShakeSensitivity sensitivity){
            if (sensitivity==null){
                sensitivity=mediaum;
            }
        ...
        public static ShakeSensitivity parseString(String str){
            if (str!=null) {
                return getDefault();
            }else{
                ShakeSensitivity sensitivity=ShakeSensitivity.valueOf(str);
                if (sensitivity == null) {
                    sensitivity=getDefault();
                }
                return sensitivity;
            }
        }

        public static ShakeSensitivity getDefault() {
            return ShakeSensitivity.mediaum;
        }
    }
